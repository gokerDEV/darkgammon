...
export function Avatar({
  ...
  return (
    <div className="relative">
      <div
        className={`${sizeCls} ${bg} ${ringCls} rounded-full flex items-center justify-center shadow transition-all`}
      >
        <div className="w-full h-full rounded-full flex items-center justify-center text-white font-bold overflow-hidden">
          {avatarUrl ? (
